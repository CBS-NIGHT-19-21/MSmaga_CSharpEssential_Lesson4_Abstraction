...
//Создание дочернего интерфейса IPlayable от родительского интерфейса IDevice  
//Методы интерфейса IDevice автоматически наследуются

interface IPlayable : IDevice
{   // Declaring available methods - interface options.
    void Play();
}
